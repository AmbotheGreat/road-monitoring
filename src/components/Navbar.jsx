...
const Navbar = ({ isSidebarOpen, setIsSidebarOpen }) => {
    ...
    return (
      <>
        ...
        <button
          ...
          className="fixed top-4 left-4 z-50 lg:hidden bg-blue-600 text-white p-2 rounded-lg shadow-lg hover:bg-blue-700 transition"
        ...
        {/* Sidebar */}
        <nav className={`fixed left-0 top-0 h-screen bg-white shadow-xl flex flex-col z-40 transition-all duration-300 
              ...
              <div className="flex items-center justify-between">
                {isSidebarOpen ? (
                  <>
                    ...
                    <button
                      onClick={() => setIsSidebarOpen(false)}
                      className="hidden lg:block text-gray-500 hover:text-gray-700 p-1 rounded-lg hover:bg-gray-100 transition"
                  ...
                  <button
                    ...
                    className="mx-auto text-blue-600 hover:text-blue-700 p-2 rounded-lg hover:bg-blue-50 transition hidden lg:block"
  ...
  // For non-admin users, render topbar
  return (
    <>
      {/* Topbar for non-admin users */}
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <NavLink
                to="/map"
                className={({ isActive }) =>
                  `px-3 py-2 text-sm font-medium rounded-md transition ${isActive
                    ? 'bg-blue-600 text-white'
                    : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'
                  }`
                }
              ...
              {user && (
                <div className="flex items-center space-x-3 ml-4 pl-4 border-l border-gray-200">
                  <span className="text-xs sm:text-sm text-gray-600 hidden lg:block">
                    {user.email}
                  </span>
                  <button
                    onClick={handleSignOut}
          ...
          <div className="md:hidden border-t border-gray-200 bg-white">
            <div className="px-4 py-3 space-y-2">
              <NavLink
                ...
                className={({ isActive }) =>
                  `block px-3 py-2 text-sm font-medium rounded-md transition ${isActive
                    ? 'bg-blue-600 text-white'
                    : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'
                  }`
                }
